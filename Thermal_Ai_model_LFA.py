...
from Resources.ai_models import LFA
...
write = SummaryWriter("runs/LFA/LFA_" + str(datetime.datetime.now().strftime("%y%m%d_%H%M")))
...
model = LFA(start_channels=start_channels, out_channels=1, fourier_modes=16, laplace_modes=12, width=64).to(device)
